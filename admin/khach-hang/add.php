                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input name="ma_khach_hang" type="text" class="form-control" id="ma-khach-hang" placeholder="Nhập mã khách hàng">
                            <span id="error-ma-khach-hang" class="text-danger">* Bắt buộc nhập</span>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <span id="error-email" class="text-danger">* Bắt buộc nhập</span>
                        </div>
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="kich-hoat" name="kich_hoat">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input name="ten_khach_hang" type="text" class="form-control" id="name" placeholder="Nhập tên khách hàng">
                            <span id="error-ten-khach-hang" class="text-danger">* Bắt buộc nhập</span>
                        </div>
                        ...
                        <div class="form-group">
                            <label>VAI TRÒ</label>
                            <select id="vai-tro" name="vai_tro" class="custom-select">
