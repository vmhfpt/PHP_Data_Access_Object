...
<section class="content">
    ...
    ?>
        <div class="card card-default">
            ...
            <form id="submit-form" action="index.php?btn_update" method="POST" >
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="code">MÃ LOẠI HÀNG (Tự động tăng)</label>
                            <input  name="ma_loai" type="hidden" value="<?=$ma_loai?>" type="text">
                            <input  value="<?=$ma_loai?>" type="text" class="form-control" id="code" placeholder="Mã loại hàng tự động tăng" disabled>
                        </div>

                        <div class="form-group">
                            <label for="name">TÊN LOẠI HÀNG</label>
                            <input value="<?=$ten_loai?>" name="ten_loai_hang" type="text" class="form-control " id="name-category" placeholder="Nhập tên loại hàng">
            ...
            <div class="card-footer">
                ...
                <a href="index.php?btn_edit&&ma_lh=<?=$ma_loai?>" class=""> <button type="button" class="btn btn-danger m-2">Nhập lại</button></a>
